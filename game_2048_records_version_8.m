...
% - "are u sure u wanna delete all your scores?)"
% 15) кнопку на тулбаре для отключния музыки(гимна)
    
function game_2048_records_version_8
global old_a
global score
global name
global record_check
...
for i = 1:size % рисуем числа
    ...
    function open_records(~,~)
     ...
     records_difficulty_sign = uicontrol('units','pixels', 'style', 'text', 'fontsize', 20, 'string', 'PROS', 'position', [75 540 350 30], 'userdata', 'records_difficulty_sign');
